...
try:
    ...
    call_command('makemigrations', 'core', '--no-input', stdout=out, stderr=err, interactive=False)
    lines.append("makemigrations core:\n" + out.getvalue())
    ...
    lines.append("check:\n" + (out3.getvalue().strip() or "OK"))

except Exception:
    lines.append(traceback.format_exc())

with open('migrate_news_result.txt', 'w', encoding='utf-8') as f:
    f.write('\n'.join(lines))
print("done")
